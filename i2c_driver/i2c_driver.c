...
//	i2c_config_lcd.mode = I2C_MODE_MASTER;
//	i2c_config_lcd.sda_io_num = 21;
//	i2c_config_lcd.scl_io_num = 22;
//	i2c_config_lcd.sda_pullup_en = 1;
//	i2c_config_lcd.scl_pullup_en = 1;
//	i2c_config_lcd.master.clk_speed = 100000;
//
//	ESP_ERROR_CHECK(i2c_configuracion_parametros(I2C_NUM_0,&i2c_config_lcd));
//	ESP_ERROR_CHECK(i2c_instalacion_driver(I2C_NUM_0,I2C_MODE_MASTER,0,0,0));
